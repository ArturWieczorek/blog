!function(){for(var e=document.querySelectorAll("h1[id],h2[id],h3[id],h4[id],h5[id],h6[id]"),t=0;t<e.length;t++){var i=document.createElement("img");i.setAttribute("src","/blog/assets/img/link-symbol.svg");var r=document.createElement("a");r.setAttribute("href","#"+e[t].getAttribute("id")),r.classList.add("anchor"),r.appendChild(i),e[t].insertBefore(r,e[t].firstChild)}}();
